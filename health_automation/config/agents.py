...
from health_automation.tools.google_search_tool import (
    search_supplements_in_spain,
    fetch_recommended_dosages,
)
...
def create_agent(
    role="", goal="", backstory="", tools=[], function_call=None, max_rpm=3
):
    """
...
dosage_specialist = create_agent(
    ...
    tools=[
        fetch_recommended_dosages,
        send_email_tool,
    ],  # 🔹 Ferramentas para busca e envio
)
